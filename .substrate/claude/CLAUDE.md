...
Couch Legend is built in TypeScript 5.9 — Vite 7 + React 19 web app, Node >=20 with pnpm; the game engine and simulator are pure TypeScript. Python 3 only for the vendored substrate-kit bootstrap..
