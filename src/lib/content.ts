...
export const KEEPSAKES: KeepsakeDef[] = [
  ...
  { id: 'earth-in-the-window', name: 'Earth in the Window', stage: 'garden-upstairs', blurb: 'Blue, slow, and entirely someone else’s problem this afternoon.', effect: { kind: 'grow-cash', share: 0.06, ceiling: 1 }, surface: 'the cash/s tile climbs when you buy a Grow row — and again when the jobs outgrow the garden' },
  ...
  { id: 'first-follower', name: 'The First Follower', stage: 'the-civilization', blurb: 'Sat down on the other end without asking. Stayed a decade.', effect: { kind: 'work-nugs', share: 0.3, ceiling: 3 }, surface: 'the nugs/s tile climbs when you buy a job — three gardens\' worth before it stops' },
